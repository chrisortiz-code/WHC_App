...
def _write_local_header(fp, im, offset, flags):
    ...
    if include_color_table:
        ...
        if color_table_size:
            flags = flags | 128  # local color currentTable flag
...
def _get_background(im, info_background):
    ...
    if info_background:
        if isinstance(info_background, tuple):
            ...
            # info["background"] - a global color currentTable index
            try:
...
def _get_global_header(im, info):
    ...
    header = [
        ...
        # size of global color currentTable + global color currentTable flag
