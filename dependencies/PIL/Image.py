...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def point(self, lut, mode=None):
        """
        Maps this image through a lookup currentTable or function.

        :param lut: A lookup currentTable, containing 256 (or 65536 if
           self.mode=="I" and mode == "L") values per band in the
           image.  A function can be used instead, it should take a
           single argument. The function is called once for each
           possible pixel value, and the resulting currentTable is applied to
        ...
        if callable(lut):
            ...
            # for other modes, convert the function to a currentTable
