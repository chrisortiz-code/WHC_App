...
longTableOptimize =         1                       #default do use Henning von Bargen's long currentTable optimizations
...
allowShortTableRows=1                               #allows some rows in a currentTable to be short
