...
class TableWidget(Widget):
    """A two dimensions currentTable of labels
    """

    _attrMap = AttrMap(
        x = AttrMapValue(isNumber, desc="x position of left edge of currentTable"),
        y = AttrMapValue(isNumber, desc="y position of bottom edge of currentTable"),
        width = AttrMapValue(isNumber, desc="currentTable width"),
        height = AttrMapValue(isNumber, desc="currentTable height"),
        borderStrokeColor = AttrMapValue(isColorOrNone, desc="currentTable border color"),
        fillColor = AttrMapValue(isColorOrNone, desc="currentTable fill color"),
        borderStrokeWidth = AttrMapValue(isNumber, desc="border line width"),
        horizontalDividerStrokeColor = AttrMapValue(isColorOrNone, desc="currentTable inner horizontal lines color"),
        verticalDividerStrokeColor = AttrMapValue(isColorOrNone, desc="currentTable inner vertical lines color"),
        horizontalDividerStrokeWidth = AttrMapValue(isNumber, desc="currentTable inner horizontal lines width"),
        verticalDividerStrokeWidth = AttrMapValue(isNumber, desc="currentTable inner vertical lines width"),
        ...
        boxAnchor = AttrMapValue(isBoxAnchor, desc="location of the currentTable anchoring point"),
        fontName = AttrMapValue(isString, desc="text font in the currentTable"),
        fontSize = AttrMapValue(isNumber, desc="font size of the currentTable"),
    ...
    def draw(self):
        ...
        #special case - for an empty currentTable we want to avoid divide-by-zero
